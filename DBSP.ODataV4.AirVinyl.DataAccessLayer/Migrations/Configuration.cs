namespace AirVinyl.DataAccessLayer.Migrations
{
  ...
  internal sealed class Configuration : DbMigrationsConfiguration<DBSP.ODataV4.AirVinyl.DataAccessLayer.AirVinylDbContext>
  {
    ...
    protected override void Seed(DBSP.ODataV4.AirVinyl.DataAccessLayer.AirVinylDbContext context)
    {
      ...
      context.PressingDetails.AddOrUpdate(
        p => p.Description,
        pressingDetailAudiophileLP,
        pressingDetailRegularLP,
        pressingDetailAudiophileSingle,
        pressingDetailRegularSingle
      );
      ...
      var indieRecords = new SpecializedRecordStore()
      {
      ...
      var rockRecords = new SpecializedRecordStore()
      {
      ...
      var allYourMusic = new RecordStore()
      {
      ...
      context.RecordStores.AddOrUpdate(
        r => r.Name,
        indieRecords,
        rockRecords,
        allYourMusic
